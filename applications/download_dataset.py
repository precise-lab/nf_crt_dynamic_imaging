...
if __name__ == "__main__":
    ...
    do_download('induced_pressure.mat', 'https://dataverse.harvard.edu/api/access/datafile/6277187')
    do_download('optical_absorption.mat', 'https://dataverse.harvard.edu/api/access/datafile/6277186')
